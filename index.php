					...
					<div id="affQ">
						<?php
							...
							while ($question[$i]["id"] > 0) {
								echo "<div class=\"question\" id=n".$question[$i]["id"]."><h5>".$question[$i++]["question"]." <a><i class=\"icon -check\"></i></a></h5></div>";
							}
							$question = get_all_question(1);
							$i = 0;
							while ($question[$i]["id"] > 0) {
								echo "<div class=\"question\" id=n".$question[$i]["id"]."><h5>".$question[$i]["question"]." <a onclick=\"upvote(".$question[$i]["id"].")\"><i class=\"icon -chevron-up\"></i></a></h5><p> votes ".$question[$i++]["upvote"]."</p></div>";
							}
						?>
					</div>
					<?php if ($_SESSION["id"]){?>
